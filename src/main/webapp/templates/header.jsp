...
<%--                </div>--%>
                ...
                <div class="col-12 mb-3 mb-md-0 col-md-6 order-1 order-md-2 text-center">
                    <div class="">
                        <a href="" class="">
                            <img style="width: 90px;" src="./static/images/logo/Air Afrika.png">
                        </a>
                    </div>
                </div>
                    ...
                    <div class="site-top-icons">
                        <ul>
                            <c:if test="${sessionScope.account != null}">
                                <li>
                                <li><a href="login.jsp"><img src="https://avatars.githubusercontent.com/u/102564698?s=400&u=c549e0a6986c23df1d9b51a9c3b88888c61219aa&v=4" class="icon icon-person w-25 h-25"></img></a></li>
