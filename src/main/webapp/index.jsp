...
<div class="site-wrap">
    ...
    <div class="site-blocks-cover m-auto" style="background-image: url(https://www.nikkel-art.fr/img-preview/aHR0cHM6Ly9hczEuZnRjZG4ubmV0L3YyL2pwZy8wMS84NC8zMy81Ni8xMDAwX0ZfMTg0MzM1NjQyX2gxTEkwWHpqeklRWUIyN3M0U1NXVERoNTJvVk5mOU1ELmpwZw==?&w=669&h=352&e=none&f=none&r=0&sv=100&sh=100&m=1);" data-aos="fade">
        <div class="container">
            <div class="align-items-start align-items-md-center justify-content-end">
                <div class="bg-dark text-center text-md-left pt-5 pt-md-0">
                    <h1 class="mb-2 text-white" style="text-align: center;">
                        Rapidly browse through all the travel websites you prefer.
                    </h1>
